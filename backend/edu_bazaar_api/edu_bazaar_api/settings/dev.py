"""
Django settings for edu_bazaar_api project.
...
SECRET_KEY = 'django-insecure-ts39*ig0v*_g*8z$td(424cvke^5(kq^#&6-3se+4@r121jqni'
...
ROOT_URLCONF = 'edu_bazaar_api.urls'
...
WSGI_APPLICATION = 'edu_bazaar_api.wsgi.application'
